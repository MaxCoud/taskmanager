...
def load_icons(path) -> dict:
    return {
        ...
        0: os.fspath(path / "icon/alphanumeric/number-0.png"),
        1: os.fspath(path / "icon/alphanumeric/number-1.png"),
        2: os.fspath(path / "icon/alphanumeric/number-2.png"),
        3: os.fspath(path / "icon/alphanumeric/number-3.png"),
        4: os.fspath(path / "icon/alphanumeric/number-4.png"),
        5: os.fspath(path / "icon/alphanumeric/number-5.png"),
        6: os.fspath(path / "icon/alphanumeric/number-6.png"),
        7: os.fspath(path / "icon/alphanumeric/number-7.png"),
        8: os.fspath(path / "icon/alphanumeric/number-8.png"),
        9: os.fspath(path / "icon/alphanumeric/number-9.png"),
        10: os.fspath(path / "icon/alphanumeric/number-10.png"),
        11: os.fspath(path / "icon/alphanumeric/number-11.png"),
        12: os.fspath(path / "icon/alphanumeric/number-12.png"),
        13: os.fspath(path / "icon/alphanumeric/number-13.png"),
        14: os.fspath(path / "icon/alphanumeric/number-14.png"),
        15: os.fspath(path / "icon/alphanumeric/number-15.png"),
        16: os.fspath(path / "icon/alphanumeric/number-16.png"),
        17: os.fspath(path / "icon/alphanumeric/number-17.png"),
        18: os.fspath(path / "icon/alphanumeric/number-18.png"),
        19: os.fspath(path / "icon/alphanumeric/number-19.png"),
        20: os.fspath(path / "icon/alphanumeric/number-20.png"),
    }
